...
create table public.payer_configurations (
...
create index idx_payer_configurations_org_id on public.payer_configurations(organization_id);
create index idx_payer_configurations_payer_id on public.payer_configurations(payer_id);
create index idx_payer_configurations_payer_name on public.payer_configurations(payer_name);
create index idx_payer_configurations_is_active on public.payer_configurations(is_active);
create index idx_payer_configurations_created_at on public.payer_configurations(created_at desc);
