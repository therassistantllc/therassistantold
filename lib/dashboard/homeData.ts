...
export function buildHomeDashboardPayload(role: string): HomeDashboardPayload {
  return {
    ...
    commandBarMetrics: [
      ...
      { key: "missing_notes", label: "Missing Notes", value: 3, href: "/billing/workqueue?work_type=documentation_missing" },
      { key: "eligibility_not_checked", label: "Eligibility Not Checked", value: 4, href: "/billing/workqueue?work_type=eligibility_needed" },
      { key: "claims_needing_action", label: "Claims Needing Action", value: 6, href: "/billing/workqueue?work_type=rejected" },
      { key: "open_tickets", label: "Open Tickets", value: 5, href: "/tickets?status=open" },
      { key: "patient_balances", label: "Patient Balances", value: 8, href: "/billing/workqueue?work_type=patient_balance" },
    ...
    revenueCycleSnapshot: [
      { label: "Total A/R", value: "$18,420", href: "/billing/workqueue" },
      { label: "Insurance A/R", value: "$12,100", href: "/billing/workqueue?work_type=pending_payer_response" },
      { label: "Patient A/R", value: "$6,320", href: "/billing/workqueue?work_type=patient_balance" },
      { label: "Denied Claims", value: "7", href: "/billing/workqueue?work_type=denied" },
      { label: "Rejected Claims", value: "3", href: "/billing/workqueue?work_type=rejected" },
      { label: "Claims >30/60/90", value: "14 / 8 / 3", href: "/billing/workqueue?work_type=no_response" },
      { label: "Unposted ERAs", value: "4", href: "/billing/workqueue?work_type=era_missing" },
    ],
