...
export type Database = {
  public: {
    Tables: {
      ...
      // ─── New tables from 20260515000000_ehr_billing_foundation ──────────
      patient_contacts: TableDef<{
          id: string;
          organization_id: string;
          client_id: string;
          contact_type: string;
      ...
      claim_workqueue_items: TableDef<{
          id: string;
          organization_id: string;
          claim_id: string;
          client_id: string | null;
      ...
      provider_payer_enrollments: TableDef<{
          id: string;
          organization_id: string;
