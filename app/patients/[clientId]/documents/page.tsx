...
export default function DocumentsPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(`/api/patients/${clientId}/documents?organizationId=${encodeURIComponent(orgId)}`, { cache: "no-store" })
      .then((r) => r.json() as Promise<{ success: boolean; documents?: DocItem[]; error?: string }>)
      .then((json) => {
