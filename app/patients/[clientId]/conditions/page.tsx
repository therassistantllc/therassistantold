...
export default function ConditionsPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(`/api/patients/${clientId}/conditions?organizationId=${encodeURIComponent(orgId)}`, { cache: "no-store" })
      .then((r) => r.json() as Promise<{ success: boolean; conditions?: Condition[]; error?: string }>)
      .then((json) => {
