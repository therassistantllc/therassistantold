...
export default function NotesPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(`/api/patients/${clientId}/notes?organizationId=${encodeURIComponent(orgId)}`, { cache: "no-store" })
      .then((r) => r.json() as Promise<{ success: boolean; notes?: NoteItem[]; error?: string }>)
      .then((json) => {
