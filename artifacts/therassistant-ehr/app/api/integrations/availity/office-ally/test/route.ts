// File: app/api/integrations/availity/test/route.ts
...
export async function POST(request: Request) {
  try {
    ...
    const integrationName = body.integrationName || "availity";
    ...
    const response: TestConnectionResponse = {
      success: true,
      message: "Connection test successful. Availity sandbox is configured and ready.",
